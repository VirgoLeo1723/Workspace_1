...
#
# Generated by export_simulation on Tue Jan 31 18:39:10 +0700 2023
#
################################################################################
...
'-reset_run' switch to the './c_accum_1.sh' script.

./c_accum_1.sh -reset_run
...
./c_accum_1.sh -noclean_files

For more information on the script, please type './c_accum_1.sh -help'.
